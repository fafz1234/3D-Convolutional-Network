...
def max_pool_3d(input, ds, ignore_border=False):
    ...
    #xxx op = DownsampleFactorMax((ds[1],ds[2]), ignore_border)
    #xxx output = op(input_4D)
    output = pool_2d(input, (ds[1],ds[2]), ignore_border)
    ...
    #xxx op = DownsampleFactorMax((1,ds[0]), ignore_border)
    #xxx outtime = op(input_4D_time)
    outtime = pool_2d(input_4D_time, (1,ds[0]), ignore_border)
